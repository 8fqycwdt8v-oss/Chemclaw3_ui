    ...
    <aside className="hidden w-64 shrink-0 flex-col border-r border-border-subtle bg-surface-sunken md:flex">
            ...
            >
              <div className="flex items-center gap-1.5">
                {conversation.contextLost && (
                  <span className="text-warn-ink" title="Server session was replaced">
                    ●
                  </span>
                )}
      ...
      <div className="border-t border-border-subtle p-3">
        <button
          ...
          className="w-full rounded-lg border border-danger/30 px-3 py-2 text-xs text-danger-ink hover:bg-danger/10"
        >
          Reset app
        </button>
      </div>
